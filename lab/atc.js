...
function capacityCheck({
  ...
  return {
    ...
    need,
    cap,
    flightsNeeded: capSeats ? Math.ceil(need / capSeats) : 0
  };
}
...
function scheduleDelayForUniformWaves({
  waves,
  firstDepMin,
  spacingMin,
  pref48
  ...
  const depTimes = Array.from({
    length: W
  }, (_, k) => F + k * S);
  const {
    binCenters,
    assignedIdx
  } = assignByQuantile(1 / W, pref48);
  let delayMin = 0;
...
function App() {
  ...
  const capHE = capacityCheck({
    waves,
    capSeats: DEFAULTS.capSeats,
    demandDir: DEMAND.HE
  });
  const capHW = capacityCheck({
    waves,
    capSeats: DEFAULTS.capSeats,
    demandDir: DEMAND.HW
  });
  ...
  const trips = [{
    ...
    name: "E↔W",
    pax: DEMAND.EW * 2,
    timeMin: bhE + DEFAULTS.layoverH + bhW
  }, {
    name: "E↔E",
    pax: DEMAND.EE * 2,
    timeMin: bhE + DEFAULTS.layoverH + bhE
  }, {
    name: "W↔W",
    pax: DEMAND.WW * 2,
    timeMin: bhW + DEFAULTS.layoverH + bhW
  }];
  ...
  const plan = useMemo(() => planAltitudes({
    legs,
    altLayers,
    sepMin
  }), [legs, altLayers, sepMin]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "ATC Hub Scheduler — 3D Segways Edition")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: "16px",
  ...
  }, "Waves, Network & Airspace"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, "Waves / day"), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: 0,
    max: 12,
    value: waves,
  ...
  }, waves)), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: "6px"
  ...
  }, "First hub arrival"), /*#__PURE__*/React.createElement("input", {
    type: "time",
  ...
  }, "Spacing (min)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: spacing,
  ...
  }, "Miles to E"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: mE,
  ...
  }, "Miles to W"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: mW,
  ...
  }, "Block time model (hrs)"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, "BH = α + β·miles")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: "6px"
  ...
  }, "Altitude layers"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    className: "chip",
    value: altString,
    onChange: e => {
      const vals = String(e.target.value || "").replace(/FL/gi, '').split(',').map(v => parseInt(String(v).trim(), 10)).filter(v => Number.isFinite(v));
  ...
  }, "Comma list, e.g., FL290, FL310, FL330")), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: "6px"
  ...
  }, "Same-alt sep (min)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: sepMin,
  ...
  }, "E spoke block"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "20px"
    }
  }, Math.round(blockMins(mE, alpha, beta)), " min")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#0b1219",
      borderRadius: "12px",
      padding: "12px"
  ...
  }, "W spoke block"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "20px"
    }
  }, Math.round(blockMins(mW, alpha, beta)), " min"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "16px"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "3D Airspace (hover pins; drag=rotate, Shift+drag=pan, wheel=zoom)"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "8px"
  ...
  }), " H↔W", /*#__PURE__*/React.createElement("span", {
    className: "legendDot",
    style: {
      background: '#ef4444',
      marginLeft: "12px"
    }
  }), " conflict"), /*#__PURE__*/React.createElement("button", {
    className: "chip",
    onClick: () => setScale(s => clamp(parseFloat((s * 1.1).toFixed(3)), 0.5, 2.5))
  ...
  }, immersive ? 'Bordered' : 'Borderless'), /*#__PURE__*/React.createElement("button", {
    className: "chip",
    onClick: resetView
    ...
    className: "stack",
    style: {
      transform: `translate(${pan.x}px, ${pan.y}px) ` + `scale(${scale}) rotateX(${rotX}deg) rotateY(${rotY}deg)`
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "slabLabel"
    }, "FL", fl), plan.assigned.filter(a => a.layerIdx === idx).map(f => {
  ...
  }, "Pins = leg cruise windows on assigned FLs. Nearer slab = lower FL."))), /*#__PURE__*/React.createElement("section", {
    className: "card",
    style: {
      padding: "16px"
    }
  ...
  }, "Fleet & Costs"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(2,minmax(0,1fr))",
      gap: "12px"
  ...
  }, "A/C at E"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: 0,
    max: 8,
    className: "chip",
  ...
  }, "A/C at W"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: 0,
    max: 8,
    className: "chip",
  ...
  }, "Ownership $/AC/day"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: Math.round(ownCost),
  ...
  }, "Block $/BH"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: bhCost,
  ...
  }, "Service $/seat-dep"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    className: "chip",
    value: svcSeat,
  ...
  }, "Value-of-time $/hr"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(2,minmax(0,1fr))",
      gap: "8px"
  ...
  }, "Travel / SchedDelay"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "12px",
      display: "grid",
      gap: "6px",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Capacity H↔E"), /*#__PURE__*/React.createElement("span", null, capHE.cap, "/", capHE.need, " ", capHE.ok ? "OK" : "Add")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between"
    }
  }, /*#__PURE__*/React.createElement("span", null, "Capacity H↔W"), /*#__PURE__*/React.createElement("span", null, capHW.cap, "/", capHW.need, " ", capHW.ok ? "OK" : "Add")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between"
    }
  }, /*#__PURE__*/React.createElement("span", null, "Conflicts (3D)"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: conflicts ? "#ef4444" : "#16a34a"
    }
  }, conflicts ? `${conflicts} flagged` : "None")), /*#__PURE__*/React.createElement("hr", {
    style: {
      borderColor: "#1f2a44",
      margin: ".5rem 0"
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Ownership"), /*#__PURE__*/React.createElement("span", null, "$", Math.round(OWN).toLocaleString("en-US"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between"
    }
  }, /*#__PURE__*/React.createElement("span", null, "Block (BH=", BHhrs.toFixed(1), "h)"), /*#__PURE__*/React.createElement("span", null, "$", Math.round(BLK).toLocaleString("en-US"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between"
    }
  }, /*#__PURE__*/React.createElement("span", null, "Servicing"), /*#__PURE__*/React.createElement("span", null, "$", Math.round(SVC).toLocaleString("en-US"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between"
    }
  }, /*#__PURE__*/React.createElement("span", null, "Travel time (avg ", (avgTravelMin / 60).toFixed(2), "h)"), /*#__PURE__*/React.createElement("span", null, "$", Math.round(TravT).toLocaleString("en-US"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between"
    }
  }, /*#__PURE__*/React.createElement("span", null, "Schedule delay (avg ", (schedDelayMin / 60).toFixed(2), "h)"), /*#__PURE__*/React.createElement("span", null, "$", Math.round(SchD).toLocaleString("en-US"))), /*#__PURE__*/React.createElement("hr", {
    style: {
      borderColor: "#1f2a44",
      margin: ".5rem 0"
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Total Logistics Cost"), /*#__PURE__*/React.createElement("span", null, "$", Math.round(TLC).toLocaleString("en-US")))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "12px",
      fontSize: "12px",
      opacity: .7,
  ...
  }, /*#__PURE__*/React.createElement("p", null, "Tip: tighter spacing reduces schedule delay but can raise same-layer conflicts. Add layers or widen banks to deconflict.")))), /*#__PURE__*/React.createElement("footer", {
    style: {
      marginTop: "16px",
      fontSize: "12px",
      opacity: .7
    }
  }, /*#__PURE__*/React.createElement("p", null, "Training abstraction: discrete FL layers and cruise-window pins. Extend with runway queues, SIDs/STARs, or weather penalties."))));
}
window.App = App;
try {
  ...
  showBootError(`React encountered an error while mounting: ${error.message}`, error);
}
