...
<div style="display:flex;justify-content:center;gap:10px;margin-bottom:20px;">
  <iframe
    src="https://youtube.com/shorts/wpPw2w7k59w?is=j1O9jygoth7rIfqW"
...
<div style="display:flex;justify-content:center;gap:10px;margin-bottom:20px;">
  <iframe
    src="https://youtube.com/shorts/AbMPQWGAfaI?is=4ymcqGk2uynlEqD5"
    style="width:48%;aspect-ratio:9/16;border-radius:12px;box-shadow:0 0 12px rgba(0,0,0,0.4);overflow:hidden;"
    frameborder="0"
    allowfullscreen>
  </iframe>
...
- **Cathay picks Thales** — the Cathay Group selected Thales to supply avionics across 48 new Airbus aircraft, one of the quieter but larger fleet-wide commitments to come out of the show.
- **Honeywell's full-stack pitch** — Honeywell Aerospace Technologies used its Changi chalet to present solutions spanning commercial airlines, business and general aviation, defence, and advanced air mobility — positioning itself across essentially every segment walking through the door.
